								...
								<ul class="about_gallery">
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 1 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img1.jpg" class="gallery-one-image img-responsive" alt=""/> 
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
															<a href="<?php echo base_url(); ?>komponen/images/about-gallery/1.jpg" rel="prettyPhoto[pp_gal]">
									...
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 2 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img2.jpg" class="gallery-one-image img-responsive" alt=""/>
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
															<a href="<?php echo base_url(); ?>komponen/images/about-gallery/2.jpg" rel="prettyPhoto[pp_gal]">
																<button class="zooming about-zooming md-trigger">
																		<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																</button>
															</a>
									...
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 3 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img3.jpg" class="gallery-one-image img-responsive" alt=""/> 
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
														    <a href="<?php echo base_url(); ?>komponen/images/about-gallery/3.jpg" rel="prettyPhoto[pp_gal]">
																<button class="zooming about-zooming md-trigger">
																		<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																</button>
															</a>
									...
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 4 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img4.jpg" class="gallery-one-image img-responsive" alt=""/>
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
															<a href="<?php echo base_url(); ?>komponen/images/about-gallery/4.jpg" rel="prettyPhoto[pp_gal]">
																<button class="zooming about-zooming md-trigger">
																		<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																</button>
															</a>
									...
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 5 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img5.jpg" class="gallery-one-image img-responsive" alt=""/>
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
															<a href="<?php echo base_url(); ?>komponen/images/about-gallery/5.jpg" rel="prettyPhoto[pp_gal]">
									...
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 6 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img6.jpg" class="gallery-one-image img-responsive" alt=""/> 
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
															<a href="<?php echo base_url(); ?>komponen/images/about-gallery/6.jpg" rel="prettyPhoto[pp_gal]">
																<button class="zooming about-zooming md-trigger">
																		<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																</button>
															</a>
								...
								<ul class="about_gallery wow fadeInRight" data-wow-delay="0.3s">
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 7 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img7.jpg" class="gallery-one-image img-responsive" alt=""/>
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
														<a href="<?php echo base_url(); ?>komponen/images/about-gallery/7.jpg" rel="prettyPhoto[pp_gal]">
															<button class="zooming about-zooming md-trigger">
																	<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
															</button>
														</a>
									...
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 8 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img8.jpg" class="gallery-one-image img-responsive" alt=""/>
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
															<a href="<?php echo base_url(); ?>komponen/images/about-gallery/8.jpg" rel="prettyPhoto[pp_gal]">
																<button class="zooming about-zooming md-trigger">
																		<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																</button>
															</a>
									...
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 9 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img9.jpg" class="gallery-one-image img-responsive" alt=""/>
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
															<a href="<?php echo base_url(); ?>komponen/images/about-gallery/9.jpg" rel="prettyPhoto[pp_gal]">
																<button class="zooming about-zooming md-trigger">
																		<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																</button>
															</a>
									...
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 10 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img10.jpg" class="gallery-one-image img-responsive" alt=""/>
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
															<a href="<?php echo base_url(); ?>komponen/images/about-gallery/10.jpg" rel="prettyPhoto[pp_gal]">
																<button class="zooming about-zooming md-trigger">
																		<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																</button>
															</a>
									...
									<li>
										<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery one image no : 11 -->
												<img src="<?php echo base_url(); ?>komponen/images/gallery-one-img11.jpg" class="gallery-one-image img-responsive" alt=""/>
												<div class="b-wrapper">
														<div class="b-animate b-from-left b-delay03 ">
														<a href="<?php echo base_url(); ?>komponen/images/about-gallery/11.jpg" rel="prettyPhoto[pp_gal]">
															<button class="zooming about-zooming md-trigger">
																	<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
															</button>
														</a>
					    ...
					    <div class="team">
							<div class='team_div'>
									...
									<div class="col-md-4 team-grid-3 wow fadeInRight" data-wow-delay="0.3s">
											<h3>Corey Miller</h3> <!-- Team Member One -->
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc risus eros, ultricies quis erat sit amet, elementum vulputate lorem. Sed at lacinia lectus, quis blandit libero.</p>
											<p>Quisque ac malesuada lectus. Proin gravida feugiat commodo. Phasellus fermentum sem ut felis vehicula aliquet. Donec rhoncus, mi et euismod dictum, purus lorem vehicula justo, a iaculis mi nulla et risus.</p>
											 <ul class="social">
					    ...
					    <div class="team">
							<div class='team_div'>
								    ...
								    <div class="col-md-4 team-grid-5 team_grid1 wow fadeInLeft" data-wow-delay="0.3s">
									    <h3>Kat Von D</h3> <!-- Team Member Two -->
									    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc risus eros, ultricies quis erat sit amet, elementum vulputate lorem. Sed at lacinia lectus, quis blandit libero.</p>
										<p>Quisque ac malesuada lectus. Proin gravida feugiat commodo. Phasellus fermentum sem ut felis vehicula aliquet. Donec rhoncus, mi et euismod dictum, purus lorem vehicula justo, a iaculis mi nulla et risus.</p>
										<ul class="social">
											<li><a href=""> <i class="fb"> </i> </a></li>
											...
											<ul class="gallery-grid-one gallery-grid-box">
												<li>
													<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 1 -->
															<img src="<?php echo base_url(); ?>komponen/images/gallery-two-img1.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
																<div class="b-animate b-from-left b-delay03 ">
																	<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-1.jpg" rel="prettyPhoto[pp_gal]">
																		<button class="zooming md-trigger">
																			<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																		</button>
																	</a>
												...
												<li>
													<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 2 -->
															<img src="<?php echo base_url(); ?>komponen/images/gallery-two-img2.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
																<div class="b-animate b-from-left b-delay03 ">
																	<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-2.jpg" rel="prettyPhoto[pp_gal]">
																		<button class="zooming md-trigger">
																				<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																		</button>
																	</a>
												...
												<li>
													<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 3 -->
															<img src="<?php echo base_url(); ?>komponen/images/gallery-two-img3.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
																<div class="b-animate b-from-left b-delay03 ">
																	<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-3.jpg" rel="prettyPhoto[pp_gal]">
																		<button class="zooming md-trigger">
																				<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																		</button>
																	</a>
									    ...
									    <ul class="gallery-grid-two gallery-grid-box">
										    <li>
												<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 4 -->
													    <img src="<?php echo base_url(); ?>komponen/images/gallery-two-img4.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
															<div class="b-animate b-from-left b-delay03 ">
																	<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-4.jpg" rel="prettyPhoto[pp_gal]">
																		<button class="zooming md-trigger">
																				<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																		</button>
																	</a>
											...
											<li>
												<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 5 -->
													    <img src="<?php echo base_url(); ?>komponen/images/gallery-two-img5.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
															<div class="b-animate b-from-left b-delay03 ">
																	<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-5.jpg" rel="prettyPhoto[pp_gal]">
																		<button class="zooming md-trigger">
																				<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																		</button>
																	</a>
											...
											<li>
												<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 6 -->
													    <img src="<?php echo base_url(); ?>komponen/images/gallery-two-img6.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
															<div class="b-animate b-from-left b-delay03 ">
																	<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-6.jpg" rel="prettyPhoto[pp_gal]">
																		<button class="zooming md-trigger">
																				<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																		</button>
																	</a>
											...
											<li>
												<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 7 -->
													    <img src="<?php echo base_url(); ?>komponen/images/gallery-two-img7.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
															<div class="b-animate b-from-left b-delay03 ">
																<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-7.jpg" rel="prettyPhoto[pp_gal]">
																	<button class="zooming md-trigger">
																			<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																	</button>
																</a>
											...
											<li>
												<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 8 -->
													    <img src="<?php echo base_url(); ?>komponen/images/gallery-two-img8.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
															<div class="b-animate b-from-left b-delay03 ">
																<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-8.jpg" rel="prettyPhoto[pp_gal]">
																	<button class="zooming md-trigger">
																			<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																	</button>
																</a>
											...
											<li class="mobile-display-on">
												<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 9 -->
													    <img src="<?php echo base_url(); ?>komponen/images/gallery-two-img9.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
															<div class="b-animate b-from-left b-delay03 ">
																<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-9.jpg" rel="prettyPhoto[pp_gal]">
																	<button class="zooming md-trigger">
																			<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																	</button>
																</a>
									    ...
									    <ul class="gallery-grid-three gallery-grid-box">
											...
											<li>
												<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 10 -->
													    <img src="<?php echo base_url(); ?>komponen/images/gallery-two-img10.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
															<div class="b-animate b-from-left b-delay03 ">
															<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-10.jpg" rel="prettyPhoto[pp_gal]">
															    <button class="zooming md-trigger">
																        <img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																</button>
															</a>
											...
											<li>
												<div class="b-link-stripe b-animate-go thickbox"> <!-- Gallery image no : 11 -->
													    <img src="<?php echo base_url(); ?>komponen/images/gallery-two-img11.jpg" class="gallery-two-image img-responsive" alt=""/>
														<div class="b-wrapper">
															<div class="b-animate b-from-left b-delay03 ">
																<a href="<?php echo base_url(); ?>komponen/images/photo-gallery/image-11.jpg" rel="prettyPhoto[pp_gal]">
																	<button class="zooming md-trigger">
																			<img src="<?php echo base_url(); ?>komponen/images/zoom.png" alt=""/>
																	</button>
																</a>
							       	...
							       	<div class="col-md-7 contact-left wow fadeInLeft">
										...
										<div class="contact-info">
												<ul class="contact-list-one">
												   ...
												   <li>Email : <a href="mailto:"> info@inktattoo.net</a></li>
									...
									<div class="col-md-5 wow fadeInRight">
										<div class="contact-form">
											<form method="post">
												...
												<textarea onfocus="this.value= '';" onblur="if (this.value == '') {this.value = 'Message';}">Message
												</textarea>
												<label class="button-two button-type-two"><input type="submit" value="Message"></label>
											</form>
										</div>
									</div>
   	                        </div>
				...
				<div class="container-fluid">
					<div class="row">
					    <div class="map-div wow fadeInDown">
						    <a href="https://www.google.com/maps/place/Aquarium+of+the+Pacific/@33.7274471,-118.2521738,12z/data="><img src="images/map.jpg" alt="" /></a>
						</div>
					</div>
				</div>
			</section>